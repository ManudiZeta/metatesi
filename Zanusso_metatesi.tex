...
%-----------------------------------------------------------------------------------------------------------------------------------------------------------------
\begin{frame}{$\bar{n}$ ECL cluster variables (1c)}
\begin{columns}  
  ...
  \begin{column}{0.35\textwidth}
     ...
     \item A lot of photons are mis-identified as $\bar{n}$ during reconstruction (backup)$\rightarrow$ further selection can be studied such as:
     \begin{center}
     $\bar{n}_{mcPDG} \neq -2112$ \&\& $	nbar\_clusterNHits > 15$
     \end{center}
     \end{itemize}
     }
   \end{column}
