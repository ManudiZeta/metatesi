...
The $\bar{n}$ plays a key role in several physics measurements, such as: 
    ...
    \item Some decay channels studied at B-factories which involved $\bar{n}$, such as:
...
\begin{columns}[T] % T = top alignment
    ...
    \begin{column}{0.45\textwidth}
        \begin{itemize}
            ...
            \item Peak Lumi $\sim 5.1 \times 10^{34} cm^{-2} s^{-1}$ \inlineimg{images/logos/coppa-del-mondo} 
            \item Design Lumi $\sim 8 \times 10^{35} cm^{-2} s^{-1}$  \\ $\rightarrow$ x40 the Belle's one 
        \end{itemize}
    \end{column}
...
%------------------------------------------------------------------------------------------------
\makesection{Study of continuum with MC cocktail}
%------------------------------------------------------------------------------------------------
...
%------------------------------------------------------------------------------------------------
\makesection{Outlook Until Graduation}
%------------------------------------------------------------------------------------------------
%-----------------------------------------------------------------------------------------------------------------------------------------------------------------
