...
\begin{columns}  
  \begin{column}{0.50\textwidth}
     {
     \begin{itemize}
     \item "Real cuts" can be applied instead of MC selections, with (b), such as: \inlineimg{images/logos/cyan}
     \vspace{0.2cm}
     	\begin{enumerate}[(a)]
	...
	\vspace{0.2cm}
	\item To select the signal, a recoil mass cut in the range (0.8-1.1) GeV can be applied to study the recoil variables
